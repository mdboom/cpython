...
enum InstructionFormat { INSTR_FMT_IB, INSTR_FMT_IBC, INSTR_FMT_IBC000, INSTR_FMT_IBC0000, INSTR_FMT_IBC000000, INSTR_FMT_IBC00000000, INSTR_FMT_IBIB, INSTR_FMT_IX, INSTR_FMT_IXC, INSTR_FMT_IXC000, INSTR_FMT_IXC0000, INSTR_FMT_IXC00000000 };
...
const struct opcode_metadata _PyOpcode_opcode_metadata[256] = {
    ...
    [BINARY_OP_MULTIPLY_INT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_OP_MULTIPLY_FLOAT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_OP_SUBTRACT_INT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_OP_SUBTRACT_FLOAT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_OP_ADD_UNICODE] = { true, INSTR_FMT_IXC0000 },
    [BINARY_OP_INPLACE_ADD_UNICODE] = { true, INSTR_FMT_IX },
    [BINARY_OP_ADD_FLOAT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_OP_ADD_INT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_SUBSCR] = { true, INSTR_FMT_IBC0000 },
    [BINARY_SLICE] = { true, INSTR_FMT_IX },
    [STORE_SLICE] = { true, INSTR_FMT_IX },
    [BINARY_SUBSCR_LIST_INT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_SUBSCR_TUPLE_INT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_SUBSCR_DICT] = { true, INSTR_FMT_IXC0000 },
    [BINARY_SUBSCR_GETITEM] = { true, INSTR_FMT_IXC0000 },
    ...
    [CALL_NO_KW_LIST_APPEND] = { true, INSTR_FMT_IBC000000 },
    [CALL_NO_KW_METHOD_DESCRIPTOR_O] = { true, INSTR_FMT_IBC000000 },
    [CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS] = { true, INSTR_FMT_IBC000000 },
    [CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS] = { true, INSTR_FMT_IBC000000 },
    ...
    [BINARY_OP] = { true, INSTR_FMT_IBC0000 },
