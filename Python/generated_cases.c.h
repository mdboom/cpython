...
// Do not edit!
        ...
        TARGET(BINARY_SLICE) {
            ...
            #line 604 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(STORE_SLICE) {
            ...
            #line 628 "Python/generated_cases.c.h"
            STACK_SHRINK(4);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_LIST_INT) {
            ...
            Py_DECREF(list);
            #line 651 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 5;
            DISPATCH();
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 854 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CALL_INTRINSIC_2) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 886 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_RETURN_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 973 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            iter = (*getter)(obj);
            #line 1040 "Python/generated_cases.c.h"
            Py_DECREF(obj);
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1145 "Python/generated_cases.c.h"
            stack_pointer[-1] = iter;
            PREDICT(LOAD_CONST);
            DISPATCH();
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1355 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
        ...
        TARGET(LOAD_LOCALS) {
            ...
            Py_INCREF(locals);
            #line 1638 "Python/generated_cases.c.h"
            STACK_GROW(1);
